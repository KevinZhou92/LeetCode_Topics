...
If we have an existing array with non-zero values, then we need extra space for storing the diffs, or we could preprocess the existing array to make it 
an diff array before starting
